...
export interface Riddle11 {
   ...
   *
   * Use case: Handle the click of a button right away,
   * but prevent double clicking by not handling multiple click events within a given time window.
   */
